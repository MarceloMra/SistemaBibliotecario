...
public class BuscaUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbTipoBusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "Tipo", "CPF", "E-mail" }));
    ...
    private void buscar() {
        if (!txtConteudoBuscar.getText().equals("")) {
            ...
            for (Usuario b : resultado) {
                ...
                tbResultado.setValueAt(b.getTipo(), i, 2);
                tbResultado.setValueAt(b.getCpf(), i, 3);
                tbResultado.setValueAt(b.getEmail(), i, 4);
                i++;
            }
        } else {
