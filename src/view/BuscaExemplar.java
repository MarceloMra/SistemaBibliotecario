...
public class BuscaExemplar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cód. Barras", "Título", "Autor", "Editora", "Data Cadastro", "Situação"
            }
        ) {
        ...
        cbTipoBusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Cod. Barras", "Título", "Autor", "Editora" }));
    ...
    private void buscar(){
        if (!txtConteudoBuscar.getText().equals("")) {
            ...
            for (ItemBuscaExemplar b : resultado) {
                dtbm.addRow(new String[i]);
                tbResultado.setValueAt(b.getIdExemplar(), i, 0);
                tbResultado.setValueAt(b.getCodBarras(), i, 1);
                tbResultado.setValueAt(b.getTitulo(), i, 2);
                tbResultado.setValueAt(b.getAutor(), i, 3);
                tbResultado.setValueAt(b.getEditora(), i, 4);
                tbResultado.setValueAt(b.getDataCadastro(), i, 5);
                tbResultado.setValueAt(b.getSituacaoExemplar(), i, 6);
                i++;
            }
        } else {
    ...
    private void selecionar(){
        try{
            ...
            for(ItemBuscaExemplar b : resultado){
                if(b.getIdExemplar()== id){
                    Exemplar e = new Exemplar();
                    e.setIdExemplar(b.getIdExemplar());
                    e.setDataCadastro(b.getDataCadastro());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaExemplar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaExemplar().setVisible(true);
            }
        });
    }
